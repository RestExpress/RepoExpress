 ...
 * @since Jan 22, 2014
 */
public abstract class DocussandraTimestampedEntityRepository<T extends TimestampedIdentifiable>
extends DocussandraEntityRepository<T>
{
	protected DocussandraTimestampedEntityRepository(CqlSession session, String tableName, String identifierColumn, Class<?> resultClass)
	{
