 ...
 * @since Apr 12, 2013
 */
public abstract class DocussandraEntityRepository<T extends Identifiable>
extends AbstractDocussandraRepository<T>
{
	 ...
	 */
    protected DocussandraEntityRepository(CqlSession session, String tableName, String identifierColumn, Class<?> resultClass)
	{
		super(session, tableName, resultClass);
